...
INSERT INTO settings(key,value,updated_at) VALUES
  ...
  ('oauth_oidc_enabled','true',$NOW),
  ('oauth_oidc_issuer_url','https://sso.example.com/oauth2/default',$NOW),
  ('oauth_oidc_client_id','peek-internal-sso-client',$NOW),
  ('oauth_oidc_client_secret','configured',$NOW),
